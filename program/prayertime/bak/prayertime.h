...
extern stTime		stPTime[MAX_PRAYERTIME];
...
extern void 	ptime_GetPrayerTime(stRealTime pstRealTime, stTime *pstPrayerTime);
extern void 	ptime_SetPrayerTime(stRealTime pstRealTime, stTime *pstPrayerTime);
