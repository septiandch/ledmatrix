...
void ptime_SetPrayerTime(stRealTime pstRealTime, stTime *pstPrayerTime)
{
...
void ptime_GetPrayerTime(stRealTime pstRealTime, stTime *pstPrayerTime)
{		
	int16_t		nTotaldays	= pstRealTime.date - 1;
	int16_t		i			= 0;
...
void ptime_GetHijriah(stRealTime *pstRealTime, stRealTime *pstHijriTime)
{
	...
	*pstHijriTime = *pstRealTime;
	...
	/* Calculate Hijri Year, dev 1400 to fit in 1 byte */
