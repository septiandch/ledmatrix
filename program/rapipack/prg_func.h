...
extern eMarqueeStat display_marquee_draw(stDisplayMsg *pstDispMsg);
extern uint8_t display_marquee_checkonpos(stDisplayMsg *pstDispMsg, int16_t wCheckPos);
extern void display_marquee_idle_set(stDisplayMsg *pstDispMsg, int16_t count, eMarqueeStat eNextStat);
