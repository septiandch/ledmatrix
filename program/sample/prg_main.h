...
#include "dmd/dmdhal_api.h"
#include "library/fmem.h"
#include "library/at24cxx.h"
...
/* Function Prototypes */
extern void			leddmd_init(void);
extern void			leddmd_get_mem(void);
extern void			leddmd_get_message(uint8_t task, char *str, uint8_t *mode, uint8_t *delay, uint8_t *iteration);
extern eTaskStatus	leddmd_set_mode(eDisplayMode mode, char *message);
extern void			leddmd_chk_event(eTimeEvent *eEventRet);
extern void			leddmd_set_powersave(uint8_t StartHour, uint8_t StartMinute, uint16_t Duration);
extern void			leddmd_get_powersave(stPowerSave *stPwrSv);
