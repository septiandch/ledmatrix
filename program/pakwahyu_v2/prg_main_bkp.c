...
#define CUSTOM_DISP_HOUR		12
#define CUSTOM_DISP_MINS		45

/*----- Global Variables -----*/
stRealTimeVar	stRTime;
stDisplayMsg	sMessage[MSGDATA_COUNT];

/*	M01#MARGARINE - TEPUNG - BUTTER - GULA HALUS - ANEKA COKLAT - SELAI - KACANG - KEJU - PEWARNA - DAN LAINNYA */
/*	M02#ANEKA LOYANG - OVEN - KLAKAT - SPATULA - JELLY ART - TRAY CAKE - SPUITS - RING CUTTER - ROLLING PIN - PISAU KUE - WIRE COOLING - TROPER - TOPLES - HIASAN ULANG TAHUN - LILIN - DAN LAINNYA */
/*	M03#ANEKA ROTI MANIS TAWAR - BROWNIS - PUDING - CROISSANT - BOLEN PISANG - BOLEN PEUYEUM - KUE PIA - CAKE ULANG TAHUN - KUE SUS - PIE BROWNIES - ANEKA COOKIES - CHEESE CAKE - STRUDEL - DAN LAINNYA */
/*	M04#COKELAT - SUSU - KEJU - KACANG - STRAWBERRY - BLUEBERRY - CREAM MOCCA - TIRAMISSU - GREEN TEA */
...
{
	uint16_t i;
	char *sTmpBuffer[MSGDATA_MAX_SIZE];
