...
#define BRD_GPIO_PIN_C     			GPIO_Pin_3

#define BRD_GPIO_APBClockCmd_HUB75 	RCC_APB2PeriphClockCmd
#define BRD_GPIO_RCC_HUB75			RCC_APB2Periph_GPIOB
#define BRD_GPIO_PORT_HUB75			GPIOB
#define BRD_GPIO_PIN_R1    			GPIO_Pin_14
#define BRD_GPIO_PIN_R2    			GPIO_Pin_11
#define BRD_GPIO_PIN_G1    			GPIO_Pin_13
#define BRD_GPIO_PIN_G2    			GPIO_Pin_12
#define BRD_GPIO_PIN_B1    			GPIO_Pin_15
#define BRD_GPIO_PIN_B2    			GPIO_Pin_10
...
#define BRD_SQW_APBClockCmd_AFIO	RCC_APB2PeriphClockCmd
#define BRD_SQW_RCC					RCC_APB2Periph_GPIOB
#define BRD_SQW_RCC_AFIO			RCC_APB2Periph_AFIO
#define BRD_SQW_PORT				GPIOB
#define BRD_SQW_PORTSOURCE			GPIO_PortSourceGPIOB
#define BRD_SQW_PIN					GPIO_Pin_5
#define BRD_SQW_PINSOURCE			GPIO_PinSource5
...
#define BRD_SPI_AFIO_RCC			RCC_APB2Periph_AFIO
#define BRD_SPI						SPI1
